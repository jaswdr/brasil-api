...
class DDDV1(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'state': (str,),  # noqa: E501
            'cities': ([bool, date, datetime, dict, float, int, list, str, none_type],),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, state, cities, *args, **kwargs):  # noqa: E501
        """DDDV1 - a model defined in OpenAPI
