...
class CEPApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __cep_v1_cep_get(
            self,
            cep,
            **kwargs
        ):
            """Busca por CEP com múltiplos providers de fallback.  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.cep_v1_cep_get(cep, async_req=True)
            >>> result = thread.get()
        ...
        self.cep_v1_cep_get = _Endpoint(
            settings={
                'response_type': (CEPV1,),
                'auth': [],
                'endpoint_path': '/cep/v1/{cep}',
                'operation_id': 'cep_v1_cep_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
