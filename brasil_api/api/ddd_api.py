    ...
    def __init__(self, api_client=None):
        ...
        def __ddd_v1_ddd_get(
            ...
            **kwargs
            ...
            >>> thread = api.ddd_v1_ddd_get(ddd, async_req=True)
            >>> result = thread.get()
        ...
        self.ddd_v1_ddd_get = _Endpoint(
            settings={
                'response_type': (DDDV1,),
                'auth': [],
                'endpoint_path': '/ddd/v1/{ddd}',
                'operation_id': 'ddd_v1_ddd_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
