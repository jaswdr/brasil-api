    ...
    def __init__(self, api_client=None):
        ...
        def __cep_v2_cep_get(
            ...
            **kwargs
            ...
            >>> thread = api.cep_v2_cep_get(cep, async_req=True)
            >>> result = thread.get()
        ...
        self.cep_v2_cep_get = _Endpoint(
            settings={
                'response_type': (CEPV2,),
                'auth': [],
                'endpoint_path': '/cep/v2/{cep}',
                'operation_id': 'cep_v2_cep_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
