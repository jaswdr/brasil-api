...
import brasil_api
from brasil_api.api.cep_v2_api import CEPV2Api  # noqa: E501


class TestCEPV2Api(unittest.TestCase):
    """CEPV2Api unit test stubs"""

    def setUp(self):
        self.api = CEPV2Api()  # noqa: E501

    def tearDown(self):
        pass

    def test_cep_v2_cep_get(self):
        """Test case for cep_v2_cep_get

        Busca por CEP com múltiplos providers de fallback v2.  # noqa: E501
        """
        pass
